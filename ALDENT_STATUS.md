...
# 2026-08-21 Lala school-uniform source mapping

```yaml
status: runtime_source_mapping_updated_verification_not_run_human_visual_review_pending
current_loop: lala_school_uniform_act_scene_mapping_2026-08-21
authorized_by:
  - user_confirmed_that_later_regular_school_scenes_should_generally_use_lala_school
  - user_explicitly_requested_mapping_only_and_no_tests_in_this_loop
authorized_scope:
  - register_complete_004_01_01_a_through_e_eye_and_mouth_pairs_as_lala_school_uniform_without_changing_the_global_default
  - bind_episode02_act03_school_episode03_act01_rooftop_and_school_episode03_act03_schoolRoad_and_episode04_act01_school
  - keep_pre_reveal_weekend_change_clothes_aquarium_and_explicit_space_suit_continuity_on_arrival_default
  - keep_the_incomplete_f_pair_out_of_runtime_expressions
forbidden_scope:
  - make_school_uniform_the_global_lala_default_or_auto_route_every_school_named_scene
  - invent_or_borrow_an_f_mouth_or_claim_a_through_e_semantics_blinking_seams_and_mask_are_human_accepted
  - add_dating_location_filters_or_modify_story_text_worldbook_dates_relationship_settlement_prompts_host_or_database_chains
connection_state: school_portrait_registered_and_selected_by_explicit_act_scene_rules_in_source_only_tests_build_browser_and_real_Tavern_not_run
overall_connection_label: source_connected_unverified
known_side_effect:
  - DatingModule_enumerates_all_registered_character_portraits_so_school_uniform_is_now_visible_to_dating_AI_without_location_filtering
verification:
  passed: []
  failed: []
  not_run:
    - tests_typecheck_lint_format_and_build_by_explicit_user_request
    - browser_PC_tablet_phone_reduced_motion_and_asset_loading
    - real_Tavern_generation_and_story_playback
    - human_a_through_e_semantic_blinking_seam_mask_and_costume_continuity_review
historical_note:
  - the_2026-08-10_calibration_record_remains_a_pre_wiring_snapshot_and_does_not_become_visual_acceptance
human_review: pending_user_review_of_school_costume_continuity_and_each_registered_expression_frame
```

# 2026-08-21 Completed dating archives in memory summary floors

```yaml
status: implementation_local_semantic_and_bundle_verified_real_tavern_human_review_pending
current_loop: completed_dating_archive_memory_floor_projection_2026-08-21
authorized_by:
  - user_reported_that_generated_dating_records_do_not_increment_or_enter_memory_summary_floors
authorized_scope:
  - project_each_completed_DatingArchive_as_one_stable_two_message_memory_floor
  - preserve_main_then_return_dialogue_once_in_the_projected_assistant_source
  - merge_main_story_and_dating_sources_by_narrative_calendar_date
  - include_dating_sources_in_automatic_manual_retry_revalidation_review_evidence_and_invalidation_paths
  - retain_the_existing_six_floor_small_summary_and_five_accepted_small_summary_large_batch_contract
forbidden_scope:
  - count_active_or_partial_dating_runs_as_complete_floors
  - create_or_disguise_dating_records_as_main_story_or_real_Tavern_host_messages
  - claim_raw_dating_prompt_or_raw_assistant_response_persistence_when_only_parsed_lines_are_archived
  - include_walk_home_records_or_change_dating_settlement_relationship_AP_money_or_date_rules
connection_state: completed_dating_snapshot_archive_to_memory_floor_projection_queue_prompt_review_and_invalidation_connected_real_secondary_API_and_human_UI_review_not_run
verification:
  passed:
    - six_Node_semantic_tests_cover_one_completed_date_equals_one_floor_both_stage_texts_once_partial_run_exclusion_main_dating_chronology_zero_to_one_queue_count_five_plus_date_equals_six_of_six_and_mixed_invalidation
    - changed_memory_source_runtime_timeline_prompt_invalidation_and_review_UI_files_have_no_TypeScript_diagnostics
    - ESLint_passed_for_all_changed_TypeScript_TSX_and_test_files
    - Prettier_passed_for_changed_source_test_and_package_files
    - direct_development_webpack_build_completed_successfully_and_emitted_dist_Tokimeki_Memorial-To-love_index_html_SHA256_C4328053809631A3AC3B1BF5A3E55F81AE32888EEA04C3DC6BE1FFD9A539A27C
    - existing_message_floor0_mirror_suite_passed_five_of_five
  failed:
    - full_project_TypeScript_check_remains_blocked_by_two_pre_existing_storyContextValidation_displayName_diagnostics_outside_this_loop
    - existing_openAICompatibleModels_suite_remains_red_one_of_six_on_its_pre_existing_v1_validation_expectation
  not_run:
    - real_secondary_API_summary_generation_from_a_completed_date
    - real_SillyTavern_save_reload_and_summary_source_review_UI_acceptance
human_review: pending_user_confirmation_that_one_completed_date_advances_5_of_6_to_6_of_6_and_the_candidate_contains_both_date_stages
```

# 2026-08-21 Dating GAL frame, long-form protocol, and generated actions

```yaml
status: source_and_inline_bundle_updated_validation_not_run_by_user_request_human_review_pending
current_loop: dating_map_frame_long_body_generated_action_labels_2026-08-21
authorized_by:
  - user_requested_rendering_the_full_date_inside_the_existing_map_frame
  - user_requested_long_AI_authored_dating_text_and_three_AI_authored_interaction_choices
  - user_requested_a_decoupled_SecondBase_style_interaction_icon_layer
  - user_required_dating_to_reuse_the_main_story_wrapper_extraction_and_render_AI_expression_cues
  - user_required_the_dating_request_to_be_prompt_injection_only_and_inherit_current_Tavern_generation_settings
  - user_identified_the_literal_User_speaker_label_as_a_likely_preset_conflict
  - user_rejected_the_local_1200_character_gate_after_a_playable_Tavern_response_was_discarded
  - user_requested_encouraging_assertive_long_form_guidance_blending_To_LOVE_Ru_romcom_energy_with_Tokimeki_Memorial_dating_pacing
authorized_scope:
  - mount_DatingScene_as_a_direct_child_of_the_existing_map_section
  - require_a_complete_supported_main_story_body_wrapper_defaulting_to_content
  - preserve_each_validated_AI_scene_focus_portrait_expression_and_effect_cue_for_GAL_rendering
  - request_12_playable_pages_and_1200_body_characters_as_an_AI_writing_target_without_rejecting_playable_shorter_text
  - parse_exactly_three_AI_labels_for_the_local_stage_option_IDs_without_emoji_fields
  - keep_relationship_AP_money_and_option_ID_settlement_local_and_authoritative
  - let_AI_choose_each_portrait_expression_while_option_visuals_remain_local_presentation_only
  - submit_only_user_input_to_TavernHelper_generate_without_model_token_sampling_history_or_preset_overrides
  - use_the_main_story_player_speaker_label_at_ni_and_render_the_saved_player_name
  - add_stage_aware_four_part_pacing_scene_expansion_pressure_and_a_silent_pre_submission_completeness_review
forbidden_scope:
  - let_AI_create_option_IDs_or_recalculate_relationship_AP_money_or_date_state
  - create_real_Tavern_messages_or_modify_the_current_preset
  - override_the_current_Tavern_model_max_output_sampling_or_context_settings
  - restore_a_separate_original_male_protagonist_or_add_adult_content
connection_state: shared_body_extraction_source_prompt_parser_map_frame_and_local_choice_presentation_connected_real_Tavern_and_visual_acceptance_not_run
verification:
  passed:
    - static_source_and_diff_review_only
    - development_inline_bundle_build_completed_successfully
  failed: []
  not_run:
    - tests_lint_typecheck_or_format_by_explicit_user_request
    - browser_desktop_mobile_screenshots
    - real_Tavern_generation_and_current_preset_output_length_acceptance
human_review: pending_user_real_Tavern_review_of_generated_length_four_part_pacing_map_frame_pagination_and_three_action_labels
```

# 2026-08-21 Riverbank dating slice with relationship ledger

```yaml
status: implementation_contract_scoped_checks_passed_final_pair_refinement_build_pending_human_review_pending
current_loop: dating_riverbank_gal_choice_and_relationship_ledger_2026-08-21
authorized_by:
  - user_requested_completing_the_riverbank_dating_code_after_identifying_missing_yuri_and_sub_axes
authorized_scope:
  - render_three_riverbank_circle_actions_inside_the_existing_GalStoryPage_choice_surface
  - settle_the_school_safe_signed_sub_axis_and_hidden_hurt_axis_in_the_local_dating_store
  - preserve_directed_girl_relations_with_tolerance_rivalry_and_yuriBond_in_the_dating_snapshot
  - pass_the_read_only_relationship_context_to_dating_generation_without_allowing_model_recalculation
  - keep_existing_friendship_romance_settlement_and_two_stage_archive_flow
forbidden_scope:
  - add_adult_content_sexual_facts_or_sexperience_persistence
  - mutate_yuriBond_from_a_generic_solo_option_without_an_explicit_pair_focused_interaction
  - create_real_Tavern_messages_worldbook_plugin_or_database_writes
  - modify_main_story_dates_unlock_rules_or_unrelated_dirty_worktree_files
connection_state: local_riverbank_UI_and_local_relationship_state_write_connected_real_Tavern_and_human_visual_acceptance_not_run
verification:
  passed:
    - DatingModule_verification_passed_including_riverbank_options_sub_hurt_settlement_and_directed_yuriBond_delta_contract
    - scoped_ESLint_passed_for_DatingModule
    - scoped_Pretty_format_check_passed_for_changed_DatingModule_files
    - scoped_TypeScript_diagnostics_do_not_reference_DatingModule
    - git_diff_check_passed_for_the_worktree
  failed:
    - full_project_TypeScript_check_remains_red_on_pre_existing_storyContextValidation_storyTimeline_and_summaryRuntime_diagnostics
  not_run:
    - verify_inline_bundle_script_because_src_webgame_ui_verify_inline_bundle_mjs_is_absent
    - development_webpack_build_after_the_final_pair_focused_riverbank_option_refinement
    - real_SillyTavern_generation_or_host_message_plugin_database_and_worldbook_acceptance
    - browser_desktop_mobile_visual_review_and_human_option_readability_acceptance
human_review: pending_user_visual_and_playable_acceptance_of_the_riverbank_choice_surface_and_relationship_feedback
```
...
overall_connection_label: GalMainStory现只在单次生成请求内注入存档玩家资料，不再改写酒馆全局User；普通卡片继续使用当前原生Persona
verification:
  passed: []
  failed: []
  not_run:
...
```yaml
status: source_implementation_updated_validation_not_run_by_user_request
current_loop: sephie_episode04_style_ai_answers_and_riko_wakeup_restore_2026-08-13
supersedes_for_current_source:
  - sephie_personality_portrait_to_riko_student_registration_bridge_2026-08-13
authorized_scope:
  - keep_the_local_Sephie_yes_or_no_consent_choice
  - generate_the_first_and_later_interview_questions_with_exactly_three_AI_authored_first_person_answers
  - render_each_question_answers_and_free_input_inside_a_VelvetRoom_local_episode04_style_blue_choice_window
  - keep_episode04_and_shared_main_story_choice_components_read_only
  - route_both_initial_decline_and_completed_profile_through_the_full_five_page_Riko_wakeup_opening
  - remove_the_Riko_opening_skip_control_and_keep_the_event_CG_after_the_opening
  - animate_Riko_eyes_and_mouth_during_the_opening_and_enable_blinking_beside_the_registration_form
  - let_a_later_Sephie_visit_from_the_personality_form_return_to_that_form_without_replaying_the_opening
forbidden_scope:
  - modify_episode04_or_other_main_story_episode_runtime
  - read_the_Izumi_JSON_at_runtime_or_use_the_current_in_use_Tavern_preset
  - skip_the_initial_Riko_wakeup_opening_from_either_Sephie_branch
  - claim_unrun_tests_build_or_browser_evidence
connection_state: scoped_source_updated_runtime_and_visual_acceptance_not_run
overall_connection_label:
  赛菲正式问题改为同一蓝色选择窗内的 AI 问题、三个 AI
  回答和自由输入；首次画像无论拒绝或完成都必须完整经过梨子五页叫醒过场，登记页梨子恢复眨眼
verification:
  passed:
    - read_only_episode04_choice_and_custom_input_contract_comparison_completed_before_implementation
    - scoped_source_and_diff_inspection_confirmed_no_new_episode04_or_shared_main_story_edits_for_this_correction
  failed: []
  not_run:
    - tests_typecheck_lint_format_or_build_by_explicit_user_request
    - browser_mocked_generateRaw_or_real_Tavern_end_to_end_flow
    - human_visual_review_of_choice_window_Riko_opening_mouth_animation_and_registration_blink
human_review: pending_future_fast_development_acceptance
```

# 2026-08-13 Sephie portrait-to-Riko registration bridge (superseded source snapshot)

```yaml
status: superseded_by_sephie_episode04_style_ai_answers_and_riko_wakeup_restore_2026-08-13
current_loop: sephie_personality_portrait_to_riko_student_registration_bridge_2026-08-13
authorized_scope:
  - present_the_first_Sephie_decision_with_the_official_blue_choice_window_as_a_local_yes_or_no_choice
  - send_no_directly_to_the_Riko_registration_event_CG_without_starting_generation
  - let_yes_show_the_first_locally_authored_question_before_the_first_generateRaw_request
  - use_the_bundled_six_stage_interview_prompt_and_ask_the_model_to_report_its_current_stage_in_the_in_memory_profile_state
  - return_only_personality_to_the_registration_draft_while_the_player_writes_appearance_in_the_registration_form
  - persist_the_completed_profile_only_after_the_player_reaches_and_confirms_the_final_registration_review
forbidden_scope:
  - read_the_Izumi_JSON_at_runtime_or_use_the_current_in_use_Tavern_preset_as_the_interview_contract
  - write_a_partial_player_profile_or_save_the_Sephie_interview_before_final_registration_review
  - claim_mocked_generateRaw_or_local_browser_evidence_proves_real_Tavern_generation
connection_state: source_UI_prompt_and_registration_handoff_connected_local_generateRaw_mock_verified_real_Tavern_generation_not_run
overall_connection_label:
  这是修正前的历史实现快照；当前源代码与验收口径以上方“Sephie AI choice window and mandatory Riko opening
  correction”为准
verification:
  passed:
    - five_of_five_new_contract_tests_passed_for_embedded_history_result_parsing_invalid_result_rejection_generateRaw_prompt_order_and_registration_save_source_wiring
    - targeted_ESLint_passed_for_the_changed_TypeScript_and_TSX_files
    - targeted_Pretty_format_check_passed_for_the_changed_source_and_styles
    - development_webpack_build_completed_successfully_and_emitted_the_updated_Tokimeki_Memorial_To_love_bundle
    - emitted_Tokimeki_Memorial_To_love_index_html_SHA256_is_B18D4A4003A97BEFC6B4E520D4C50584F9779B8007407293B9E62BB9EE2EB749
    - local_browser_no_branch_reached_the_Riko_event_CG_without_calling_generateRaw
    - local_browser_yes_branch_displayed_the_locally_authored_first_question_before_generation
    - mocked_generateRaw_browser_flow_received_the_expected_bundled_six_stage_prompt_shape_and_completed_the_personality_handoff
    - final_local_browser_recheck_showed_zero_console_errors_for_both_branches_the_mocked_failure_retry_path_and_the_personality_only_result_handoff
  failed:
    - full_TypeScript_check_remains_red_on_17_existing_Calendar_storyContextValidation_storyTimeline_and_summaryRuntime_errors_and_none_reference_the_changed_files
  not_run:
    - real_Tavern_generateRaw_interview_response_prompt_itemization_or_end_to_end_registration_save
    - real_model_confirmation_that_the_prompt_guided_six_stage_interview_does_not_complete_early
human_review: pending_real_tavern_generation_and_final_visual_narrative_acceptance
```

# 2026-08-13 Sephie runtime asset cleanup

```yaml
status: source_cleanup_and_dist_runtime_allowlist_build_verified
current_loop: sephie_remove_unreferenced_candidates_and_publish_only_current_three_assets_2026-08-13
authorized_by:
  - user_asked_which_Sephie_assets_are_currently_used_and_to_delete_unused_assets
kept_runtime_assets:
  - sephie_body_runtime_v11.png
  - sephie_a_eye.png
  - sephie_a_mouth.png
verification:
  passed:
    - removed_126_confirmed_temporary_obsolete_and_QA_targets_totaling_about_61_MB
    - preserved_V11_rebuild_inputs_and_explicit_authoring_archives_after_destructive_scope_guard
    - webpack_dist_allowlist_leaves_exactly_three_Sephie_runtime_files_totaling_about_1_21_MiB
    - development_webpack_build_completed_successfully_after_cleanup
    - source_and_dist_hashes_match_for_all_three_runtime_assets
  failed: []
  not_run:
    - additional_deletion_of_rebuild_inputs_calibration_demo_or_authoring_archives_without_explicit_destructive_approval
human_review: not_required_for_runtime_asset_inventory_cleanup
```

# 2026-08-11 request-scoped host User takeover

```yaml
status: implementation_verified_local_contract_and_build_real_tavern_human_review_pending
current_loop: save_player_profile_takes_over_host_user_during_story_generation_2026-08-11
authorized_by:
  - user_confirmed_the_game_should_make_Tavern_treat_the_save_profile_as_User_instead_of_the_currently_mounted_role
authorized_scope:
  - capture_the_current_Persona_id_expanded_user_name_and_live_Persona_Description_before_generation
  - use_persona_set_temp_so_preset_user_macros_resolve_to_the_frozen_save_displayName_during_the_request
  - mask_the_external_live_Persona_Description_and_Persona_Lore_for_the_same_story_request
  - restore_the_original_Persona_name_and_description_on_success_error_and_cancellation_paths
  - refuse_generation_when_the_original_Persona_cannot_be_captured_or_the_temporary_name_cannot_be_verified
  - preserve_a_manual_Persona_switch_made_by_the_user_while_generation_is_in_progress
forbidden_scope:
  - create_rename_delete_rebind_or_persistently_modify_any_real_SillyTavern_Persona_record
  - modify_the_active_preset_saved_worldbook_or_Persona_Lore_binding
  - claim_local_contract_or_bundle_evidence_proves_the_real_final_Tavern_prompt
connection_state: source_generation_wrapper_local_host_adapter_contract_and_development_bundle_connected_real_tavern_prompt_inspection_not_run
overall_connection_label:
  主线生成窗口现由存档 PlayerProfile 临时接管宿主 User 名称与描述；真实 Persona
  档案不改写，真实酒馆最终提示与恢复过程仍待人工验收
verification:
  passed:
    - player_Persona_host_takeover_contract_passed_7_of_7_including_success_failure_rejected_and_malformed_takeover_manual_switch_restore_failure_and_missing_Persona_cases
    - scoped_ESLint_passed_for_the_changed_TypeScript_source
    - git_diff_check_passed
    - development_webpack_build_completed_and_emitted_dist_webgame_ui_index_html
    - emitted_inline_artifact_contains_persona_set_temp_active_persona_name_and_request_takeover_contract_markers
    - emitted_inline_artifact_SHA256_is_84768491F8F1317EEAD13B57CC9A98AD328F277484953D7A88A995594C745094
  failed:
    - webgame_ui_TypeScript_check_with_src_webgame_ui_tsconfig_remains_red_on_17_existing_CalendarModule_storyContextValidation_storyTimeline_and_summaryRuntime_diagnostics_and_none_reference_the_changed_files
  not_run:
    - verify_inline_bundle_script_because_src_webgame_ui_verify_inline_bundle_mjs_is_absent_from_the_repository
    - real_SillyTavern_Prompt_Itemization_or_Prompt_Inspector_with_a_conflicting_female_Persona_name_description_and_Persona_Lore
    - real_Tavern_before_during_after_confirmation_of_Persona_id_user_macro_description_preset_and_worldbook_state
human_review: pending_real_tavern_final_prompt_source_exclusion_and_original_Persona_restoration
```
...
overall_connection_label:
  第一集第二幕已改用首个 home 正文页之前的宽松 CG 边界；AI 只需在美柑情节点开始时切换
  scene，源码尚未按用户要求执行测试或现场验收
verification:
  passed: []
  failed: []
  not_run:
...
# 2026-08-13 Sephie transparent portrait and speaking loop

```yaml
status: implementation_and_local_browser_visual_contract_verified_human_visual_review_pending
current_loop: sephie_remove_baked_cream_background_preserve_original_texture_and_continue_mouth_animation_2026-08-13
authorized_by:
  - user_requested_removal_of_the_white_background_and_digital_noise_from_Sephie
  - user_identified_the_cream_regions_between_hair_strands_as_remaining_background_not_hair
  - user_requested_a_visible_mouth_moving_expression
authorized_scope:
  - derive_a_new_RGBA_body_from_existing_local_Sephie_sources_without_repainting_the_character
  - preserve_pink_hair_dark_linework_costume_skin_and_existing_eye_mouth_atlas_windows
  - remove_the_baked_cream_regions_between_hair_strands_and_edge_color_contamination
  - keep_mouth_sheet_animation_running_while_Sephie_is_speaking_and_stop_it_while_the_answer_composer_is_open
  - update_the_asset_builder_and_development_dist_artifact
forbidden_scope:
  - redesign_or_repaint_Sephie
  - claim_local_browser_evidence_is_real_Tavern_host_or_human_visual_acceptance
connection_state: source_portrait_asset_animation_state_builder_and_development_dist_connected_local_browser_verified
overall_connection_label: Sephie_V11_is_connected_with_transparent_hair_gaps_original_texture_and_continuous_speaking_animation_real_human_visual_acceptance_pending
verification:
  passed:
    - v11_has_one_visible_foreground_component_no_visible_small_alpha_islands_and_all_eight_baked_cream_regions_have_median_alpha_zero
    - pink_hair_visibility_is_99_981_percent_and_dark_linework_visibility_is_100_percent_in_the_static_asset_audit
    - eye_and_mouth_atlas_windows_are_byte_identical_to_the_trusted_body
    - browser_actual_velvet_room_screenshot_shows_the_room_background_through_the_hair_gaps
    - browser_computed_style_after_5_25_seconds_reports_sephie_mouth_sheet_iteration_count_infinite_and_running
    - opening_the_answer_composer_sets_data_speaking_false_and_removes_the_mouth_animation
    - runtime_asset_builder_is_deterministic_across_two_runs
    - development_webpack_build_completed_and_source_and_dist_v11_SHA256_match
  failed:
    - full_project_TypeScript_check_remains_red_on_pre_existing_unrelated_diagnostics
  not_run:
    - real_SillyTavern_embedded_runtime_and_final_user_visual_acceptance
human_review: pending_user_confirmation_of_the_final_hair_edge_and_expression_in_the_real_target_view
```

# 2026-08-13 chat[0].extra MessageArchive sidecar PoC

```yaml
status: implementation_and_local_contract_verified_real_tavern_lifecycle_not_run
current_loop: floor0_message_archive_sidecar_poc_2026-08-13
authorized_by: user_requested_the_smallest_decoupled_increment_that_makes_MessageArchive_visible_in_chat0_extra
authorized_scope:
  - keep_the_existing_tavern_file_archive_as_the_only_save_and_load_authority
  - after_a_verified_file_write_attempt_a_non_blocking_namespaced_mirror_into_existing_chat0_extra
  - preserve_foreign_extra_fields_and_never_create_delete_hide_or_reorder_host_messages
  - isolate_the_host_adapter_from_save_and_the_existing_message_file_RPC_contract
forbidden_scope:
  - read_or_restore_game_state_from_chat0_extra
  - turn_the_sidecar_into_true_same_layer_v2_authority
  - create_hidden_user_or_assistant_floors_or_trigger_MESSAGE_SENT_plugins_or_databases
connection_state: floor0_extra_sidecar_source_and_mock_contract_connected_real_host_persistence_not_run
verification:
  passed:
    - five_Node_contract_tests_cover_foreign_extra_preservation_exact_message_id_0_patch_refresh_none_idempotency_stale_revision_topology_chatId_and_failure_isolation
    - targeted_strict_TypeScript_check_for_floor0Mirror_passed
    - targeted_ESLint_and_Prettier_checks_passed
    - direct_development_webpack_build_completed_successfully
    - full_project_TypeScript_output_contains_only_pre_existing_calendar_story_template_and_memory_diagnostics_and_no_changed_file_diagnostic
  failed:
    - full_project_TypeScript_check_remains_red_on_pre_existing_unrelated_diagnostics
  not_run:
    - real_SillyTavern_chat0_extra_write_and_runtime_readback
    - forced_reload_A_to_B_to_A_chat_switch_and_JSONL_export_import_persistence
    - full_lifecycle_chat_length_equals_one_and_getLastMessageId_equals_zero
    - multi_tab_concurrency_large_archive_size_and_save_failure_injection
    - exact_inline_regex_replacement_and_legacy_entity_decode_checker_because_the_documented_checker_is_not_present_in_this_workspace
human_review: pending_real_tavern_sidecar_visibility_and_lifecycle_confirmation
```

# 2026-08-17 Free-roam character interaction scene

```yaml
status: implementation_contract_direct_webpack_and_local_browser_flow_verified_real_tavern_and_human_visual_review_pending
current_loop: share_main_GAL_renderer_restore_three_topics_fix_portrait_scale_and_isolate_menu_HUD_2026-08-17
authorized_by:
  - user_requested_character_encounters_to_open_a_full_action_scene_instead_of_returning_one_line_of_text
  - user_rejected_the_first_action_panel_as_lacking_Galgame_feel_and_requested_the_same_dialogue_box_as_main_GAL_text
  - user_reported_that_three_topic_extraction_appeared_ineffective_and_identified_the_white_dot_yellow_triangle_artifact
  - user_reported_the_full_height_portrait_scale_as_incorrect_and_requested_about_three_quarters_scene_height
  - user_reported_the_relationship_phase_AP_and_back_controls_overlapping_in_the_menu_header
authorized_scope:
  - open_the_interaction_scene_from_map_character_location_marker_or_nearby_character_without_consuming_AP
  - focus_one_full_body_character_and_keep_up_to_four_same_location_characters_as_switch_chips
  - provide_talk_gift_together_observe_closer_and_leave_actions_with_honest_lock_states
  - deterministically_offer_three_local_authored_topics_and_play_three_to_five_beats_before_final_AP_settlement
  - make_friendship_and_romance_authoritative_and_derive_display_affection_from_their_average
  - keep_the_action_menu_free_of_automatic_formula_greetings_and_only_render_dialogue_after_a_player_action
  - reuse_the_exact_main_GalStoryPage_choice_dialogue_nameplate_and_progress_components_instead_of_a_parallel_galbox
  - remove_the_custom_white_dot_and_yellow_triangle_pseudo_element_from_the_scene
  - keep_desktop_menu_topic_and_dialogue_portraits_at_about_seventy_five_percent_of_scene_height_with_feet_bottom_aligned
  - isolate_the_menu_HUD_from_the_main_story_five_column_controls_grid_and_keep_relationship_phase_AP_and_back_non_overlapping
  - keep_the_scene_responsive_inside_the_existing_map_frame
forbidden_scope:
  - AI_or_Tavern_generation_host_message_floors_worldbook_writes_or_date_memory
  - claim_gifts_observation_limits_or_the_non_main_date_system_are_implemented
  - explicit_adult_content_or_incorrect_character_unlocks
  - relabel_family_restaurant_or_school_corridor_fallbacks_as_exact_cafeteria_or_music_room_art
connection_state: local_authored_data_map_entry_scene_renderer_final_settlement_relationship_store_and_assets_connected
verification:
  passed:
    - fourteen_Node_contract_tests_cover_six_authored_profiles_stable_three_topic_selection_interpolation_unknown_card_fallback_immediate_legacy_relationship_projection_and_clamping_exact_gates_single_settlement_locked_character_rejection_all_location_assets_CSS_parse_responsive_contract_server_rendered_six_action_surface_and_shared_GAL_renderer_contract
    - the_topic_mode_class_is_is-topics-mode_and_topic_visibility_no_longer_depends_on_the_old_singular_CSS_selector_that_hid_the_three_options
    - menu_mode_server_render_contains_no_formula_greeting_no_GalStoryPage_dialogue_and_no_custom_accent_pseudo_element
    - local_real_browser_flow_reached_map_avatar_menu_three_distinct_topic_buttons_and_the_four_beat_main_GAL_dialogue_view
    - browser_DOM_confirmed_the_topic_buttons_as_摇摇欲坠的书_收拾残局_and_多出来的午饭_and_the_dialogue_started_with_a_non_formula_narration_beat
    - browser_screenshots_confirmed_the_white_dot_yellow_triangle_decoration_is_absent_from_menu_topic_and_dialogue_states
    - CSS_contract_locks_desktop_menu_topic_and_dialogue_portrait_stages_to_seventy_five_percent_height_and_one_hundred_percent_image_max_height
    - source_and_SSR_contract_confirm_the_menu_HUD_no_longer_mounts_gal-main-story__controls_and_uses_an_independent_flex_layout_without_grid_columns
    - the_independent_HUD_keeps_intrinsic_pill_widths_and_hides_only_the_relationship_summary_below_760px_while_preserving_phase_AP_and_back
    - rebuilt_index_contains_the_independent_HUD_marker_and_no_longer_contains_the_conflicting_main-story-plus-menu-controls_class_pair
    - paid_sequences_disable_map_exit_until_final_settlement_and_the_runtime_owns_action_rewards_logs_and_main_story_availability_rechecks
    - mobile_dialogue_uses_scrollable_complete_text_instead_of_line_clamping_and_mode_changes_move_keyboard_focus
    - all_nineteen_copied_background_files_match_the_local_source_archive_by_SHA256_including_the_residential_evening_variant
    - character_presence_and_main_story_time_regressions_passed_12_of_12
    - ESLint_passed_for_all_changed_TypeScript_TSX_and_test_files
    - Prettier_passed_for_all_changed_source_test_and_package_files
    - direct_webpack_development_build_completed_successfully_and_copied_new_background_assets
    - source_audit_confirmed_no_remaining_direct_one_line_map_talk_or_fixed_plus_five_affection_path
    - asset_semantics_cross_checked_against_the_local_official_background_table
  failed:
    - full_project_TypeScript_gated_build_remains_red_on_pre_existing_calendar_story_context_story_timeline_and_memory_summary_diagnostics_with_no_changed_file_diagnostic
    - standalone_static_server_cannot_resolve_some_Tavern_host_dependent_image_URLs_so_its_screenshots_are_valid_for_structure_and_artifact_absence_but_not_final_asset_fidelity
  not_run:
    - real_SillyTavern_embedded_runtime_visual_and_input_acceptance
    - final_human_visual_review_on_desktop_phone_portrait_and_phone_landscape
human_review: pending_user_acceptance_of_shared_main_GAL_visual_fidelity_character_scale_menu_readability_and_To_LOVE_Ru_comedy_tone_in_the_real_target_view
```
