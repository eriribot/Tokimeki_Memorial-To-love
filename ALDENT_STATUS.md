...
```yaml
status: implementation_source_connected_scoped_checks_passed_static_preview_ready_real_tavern_qa_pending
current_loop: completed_dating_archive_read_history_replay_2026-08-21
authorized_by:
  - user_requested_that_non_mainline_completed_dates_also_appear_in_the_read_story_archive
authorized_scope:
  - include_completed_dating_archives_with_saved_body_lines_in_the_existing_read_story_entry_gate
  - show_a_calendar_sorted_non_mainline_dating_section_with_character_location_date_quality_and_saved_line_count
  - provide_read_only_main_and_return_stage_replay_from_the_persisted_dating_archive
  - keep_dating_choices_generation_relationship_settlement_and_active_run_state_out_of_replay
forbidden_scope:
  - include_active_cancelled_or_empty_dating_runs_as_read_history
  - mutate_dating_archives_appointments_AP_relationships_or_calendar_state_from_replay
  - merge_dating_archives_into_main_story_act_archives_or_change_main_story_context_validation
  - create_new_test_or_verify_scripts_under_the_project_QA_contract
connection_state: dating_archive_to_read_history_entry_and_read_only_replay_connected_static_bundle_served
verification:
  passed:
    - scoped_ESLint_passed_for_App_SchoolMap_StoryHistoryArchive_and_DatingHistoryPlayback
    - scoped_Pretty_format_check_passed_for_changed_UI_files
    - development_webpack_build_completed_successfully
    - static_preview_server_returned_HTTP_200_for_dist_webgame_ui_index_html
  failed: []
  not_run:
    - full_project_TypeScript_check_remains_blocked_by_pre_existing_repository_diagnostics
    - browser_visual_review_of_date_only_history_entry_and_replay_on_PC_mobile
    - QA_owned_verify_scripts_and_real_save_reload_acceptance
human_review: pending_user_playthrough_of_completed_date_replay_and_main_story_regression
```

# 2026-08-21 Calendar-authoritative memory chronology

```yaml
status: implementation_source_connected_scoped_checks_passed_full_typecheck_blocked_real_tavern_qa_pending
current_loop: calendar_authoritative_memory_summary_timeline_2026-08-21
authorized_by:
  - user_reported_that_memory_summaries_can_confuse_the_timeline_even_though_calendar_records_main_story_events
authorized_scope:
  - project_the_existing_main_story_act_trigger_dates_action_numbers_and_completed_dating_archive_dates_into_prompt_only_timeline_ledgers
  - instruct_small_and_large_summary_models_to_preserve_the_local_ledger_order_and_not_infer_repair_or_rewrite_dates
  - include_calendar_timeline_metadata_in_source_fingerprints_so_date_registry_changes_invalidate_old_summary_sources
  - keep_summary_archive_shapes_calendar_event_registration_state_progression_and_settlement_authority_unchanged
forbidden_scope:
  - use_calendar_image_assets_as_runtime_event_data
  - let_AI_change_AP_date_period_money_attributes_event_completion_relationships_or_settlement
  - add_persistent_timeline_migrations_real_Tavern_messages_shujuku_database_links_or_new_QA_scripts
connection_state: projection_to_small_and_large_prompt_connected_archive_persistence_unchanged
verification:
  passed:
    - scoped_ESLint_passed_for_summaryPrompts_ts_and_summaryRuntime_ts
    - scoped_Pretty_format_check_passed_for_summaryPrompts_ts_and_summaryRuntime_ts
    - development_webpack_build_command_completed_successfully
    - changed_file_diagnostics_do_not_appear_in_full_TypeScript_output
  failed:
    - full_project_TypeScript_check_remains_blocked_by_pre_existing_storyContextValidation_global_declaration_and_dependency_type_errors
  not_run:
    - QA_owned_verify_scripts
    - real_Tavern_summary_generation_and_save_reload_acceptance
    - human_review_of_mixed_main_story_dating_calendar_order_and_date_conflict_omission
human_review: pending_QA_acceptance_points_and_user_playthrough
```

# 2026-08-21 Softer dating direction with a longer natural page range

```yaml
status: prompt_direction_softened_source_only_qa_and_real_tavern_acceptance_pending
current_loop: dating_longer_natural_page_range_soft_guidance_2026-08-21
authorized_by:
  - user_reported_that_the_dating_page_count_was_too_low_and_the_rules_were_too_rigid
authorized_scope:
  - replace_the_12_page_minimum_with_a_soft_20_to_28_page_natural_range
  - retain_1200_Chinese_characters_as_an_approximate_desired_body_size_without_counting_pressure
  - rewrite_creative_style_and_pacing_commands_as_preferences_possibilities_and_room_for_idle_intimacy
  - keep_only_parser_container_cue_and_three_registered_option_requirements_strict
forbidden_scope:
  - change_the_parser_stage_plan_context_projection_settlement_or_UI
  - let_AI_change_option_ID_relationship_AP_money_date_or_other_authoritative_state
  - create_new_test_or_verify_scripts_under_the_project_QA_contract
connection_state: existing_dating_generation_chain_unchanged_prompt_creative_pressure_softened_real_Tavern_quality_not_run
verification:
  passed: []
  failed: []
  not_run:
    - tests_verify_typecheck_lint_build_and_browser_under_the_project_QA_contract
    - real_Tavern_page_count_pacing_repetition_and_character_voice_acceptance
human_review: pending_QA_and_user_playthrough_comparison_against_the_previous_12_page_prompt
```

# 2026-08-21 Dating writing guide and readable continuity context

```yaml
status: source_connected_format_parsed_qa_and_real_tavern_acceptance_pending
current_loop: dating_rise_ix_writing_guide_and_context_projection_2026-08-21
authorized_by:
  - user_requested_converting_the_supplied_dating_style_notes_into_the_generation_guide
  - user_requested_encouraging_the_model_to_write_more_than_1200_characters
  - user_requested_dating_generation_to_read_context_and_expose_it_in_ContextPreviewModal
authorized_scope:
  - organize_the_dating_prompt_as_role_rules_four_step_pacing_original_style_calibration_examples_and_output_protocol
  - keep_the_existing_12_page_target_and_state_the_1200_Chinese_character_target_once_in_encouraging_language
  - preserve_character_age_and_limit_school_dating_to_romantic_non_explicit_intimacy
  - project_the_latest_six_accepted_main_story_or_completed_dating_messages_into_the_dating_user_input
  - use_one_deterministic_projection_for_both_Tavern_generation_and_ContextPreviewModal
  - add_a_read_only_context_icon_inside_loading_error_choice_and_playback_dating_states
forbidden_scope:
  - add_explicit_sexual_behavior_to_school_character_generation
  - let_AI_change_option_ID_relationship_AP_money_date_or_settlement_authority
  - pass_model_sampling_token_history_or_preset_overrides_to_TavernHelper_generate
  - create_real_Tavern_messages_or_connect_shujuku_database_plugin_or_same_layer_chains
  - create_new_test_or_verify_scripts_under_the_project_QA_contract
connection_state: local_snapshot_and_accepted_narrative_read_connected_to_dating_user_input_and_read_only_review_UI_real_Tavern_and_human_quality_not_run
verification:
  passed:
    - Prettier_parsed_and_formatted_all_changed_TS_TSX_and_CSS_files
    - static_boundary_review_kept_generation_projection_prompt_call_store_settlement_and_GAL_rendering_separate
    - static_call_chain_review_confirmed_the_same_projection_supplies_generation_and_active_dating_preview
  failed: []
  not_run:
    - tests_verify_typecheck_lint_and_build_under_the_project_QA_contract
    - browser_desktop_mobile_keyboard_and_overlay_visual_review
    - real_Tavern_generation_length_style_wrapper_portrait_and_three_option_acceptance
    - human_review_of_context_relevance_character_voice_comedy_pacing_and_non_repetition
human_review: pending_QA_acceptance_points_and_user_real_date_playthrough
```
